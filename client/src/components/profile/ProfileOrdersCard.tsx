        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600">Track your order history</p>
            </div>
          </div>
          {loading && (
            ...
            {orders.slice(0, 5).map((order) => (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <Link
                    href={`/order/${order.clientOrderId || order._id}`}
                    className="ml-4 flex items-center gap-1 px-3 py-2 text-sm font-medium text-slate-600 hover:text-slate-900 rounded-lg hover:bg-slate-100/50 transition-colors opacity-0 group-hover:opacity-100"
                  >
                    <IconEye size={16} />
                    View
                  </Link>
            ...
            {orders.length > 5 && (
              <div className="text-center pt-4 border-t border-slate-200/50">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-600 hover:text-slate-900 rounded-lg hover:bg-slate-100 transition-colors"
                >
                  View All Orders
                  <IconChevronRight size={16} />
                </Link>
